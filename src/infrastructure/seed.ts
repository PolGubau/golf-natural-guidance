...
const teachers: Teacher[] = [
  ...
  email: `facturacion.${String(id)}@academia-demo.example`,
  fiscalName: `${String(name)} Servicios de Golf`,
  fiscalId: `X${String(id).padEnd(7, "0").slice(0, 7).toUpperCase()}A`,
  fiscalAddress: "C/ Demo, 1 · 00000 Ciudad",
  invoiceSeries: `DEMO-${String(id).toUpperCase()}`,
  ...
  const data: DemoData = {
    ...
    leads: [
      ...
      },
      {
        ...
        stage: "qualified",
        score: 81,
        nextAction: "Compartir horarios con el equipo",
    ...
    settings: {
      ...
      academyContact: {
        ...
        website: "academia-demo.example",
        location: "Campo de golf de ejemplo · Dirección pendiente",
      },
    },
  };
